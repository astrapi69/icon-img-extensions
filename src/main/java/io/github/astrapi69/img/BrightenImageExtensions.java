...
public class BrightenImageExtensions
{
	 ...
	 * @param outputFile
	 *            The output file to save the brightened image
	 * @param scaleFactor
	 *            The factor to scale brightness (e.g., 1.2f = 20% brighter)
	 * @throws Exception
	 *             If an I/O or image processing error occurs
	 */
	public static void brightenPngImage(File inputFile, File outputFile, float scaleFactor)
		throws Exception
	{
		// 1. Read image
